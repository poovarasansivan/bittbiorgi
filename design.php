...
<body>
  ...
  <div class="container111">
    ...
    <p class="ideap">(4) Social impact & technical viability</p>
    <p class="ideap">(5) Scalability and finance</p>
    <p class="ideap">(6) MVP & beyond (acceleration, hackethons etc.,)</p>
    <h1 class="ideah">TBI will issue certification for the IMPACT PLUS</h1>
  </div>
</body>
</html>
