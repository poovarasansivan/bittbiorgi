  ...
  <body>
    ...
    <header>
      ...
      <div class="navigation">
        <ul class="menu">
        <li class="logo"><a href="#"><img src="assets/img/logo2.png" alt="Your Logo"></a></li>
          ...
          <ul class="sub-menu">
              ...
              <li class="sub-item"><a href="design.php">DESIGN COLLOQUIUM</a></li>
            </ul>
        </li>
